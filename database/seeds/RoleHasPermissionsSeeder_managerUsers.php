...
class RoleHasPermissionsSeeder_managerUsers extends Seeder
{
    ...
    public function run()
    {
        ...
        $managerIIIRole->givePermissionTo(['USERS-list', 'USERS-show', 'USERS-search']);
        $managerIIIRole->givePermissionTo(['USERS-activate','USERS-inactivate']);
        $managerIIIRole->givePermissionTo(['USERS-create','USERS-update', 'USERS-delete']);
